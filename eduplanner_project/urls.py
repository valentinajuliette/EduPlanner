...
from Calendar.views import calendar_view, pag_principal, agregar_evento, panel_admin, editar_evento, eliminar_evento, FeriadosAPIView
...
urlpatterns = [
    ...
    path('editar-evento/<int:evento_id>/', editar_evento, name='editar_evento'),
